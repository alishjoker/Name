...
[Cek ban]
[Alishjoker mid]
[Alishjoker ︎invite:「mid」]
[Alishjoker ︎rename:「name」]
[Alishjoker ︎gift]
[Respo︎n]
[Bot cancel]
[Title:]
...
wait = {
    ...
    "dblack":False,
    "clock":True,
    "cName":"﷽؏لے؁شـʝ۝KSejzΞℜ؁جۏڪ؁ࢪمﷺ痔へっぉ～受けガオっzく011びぇ受けＢＯＴ生活受けうーすぐ ",
    "blacklist":{},
    "wblacklist":False,
    "dblacklist":False,
    "protectionOn":True,
...
def bot(op):
    try:
        ...
        if op.type == 26:
            ...
            if msg.contentType == 13:
               if wait["wblack"] == True:
            ...
            elif ("Alishjoker1 gn " in msg.text):
                if msg.toType == 2:
                    X = cl.getGroup(msg.to)
                    X.name = msg.text.replace("Alishjoker1 gn ","")
                    ki.updateGroup(X)
                else:
                    ki.sendText(msg.to,"It can't be used besides the group.")
            elif ("Alishjoker2 gn " in msg.text):
                if msg.toType == 2:
                    X = cl.getGroup(msg.to)
                    X.name = msg.text.replace("Alishjoker2 gn ","")
                    kk.updateGroup(X)
                else:
                    kk.sendText(msg.to,"It can't be used besides the group.")
            elif ("Alishjoker3 gn " in msg.text):
                if msg.toType == 2:
                    X = cl.getGroup(msg.to)
                    X.name = msg.text.replace("Alishjoker3 gn ","")
                    kc.updateGroup(X)
                else:
            ...
            elif "Alishjoker1 kick " in msg.text:
                midd = msg.text.replace("Alishjoker1 kick ","")
                ki.kickoutFromGroup(msg.to,[midd])
            elif "Alishjoker2 kick " in msg.text:
                midd = msg.text.replace("Alishjoker2 kick ","")
                kk.kickoutFromGroup(msg.to,[midd])
            elif "Alishjoker3 kick " in msg.text:
                midd = msg.text.replace("Alishjoker3 kick ","")
                kc.kickoutFromGroup(msg.to,[midd])
            elif "Invite " in msg.text:
                midd = msg.text.replace("Invite ","")
                cl.findAndAddContactsByMid(midd)
                cl.inviteIntoGroup(msg.to,[midd])
            elif "Alishjoker1 invite " in msg.text:
                midd = msg.text.replace("Alishjoker1 invite ","")
                ki.findAndAddContactsByMid(midd)
                ki.inviteIntoGroup(msg.to,[midd])
            elif "Alishjoker2 invite " in msg.text:
                midd = msg.text.replace("Alishjoker2 invite ","")
                kk.findAndAddContactsByMid(midd)
                kk.inviteIntoGroup(msg.to,[midd])
            elif "Alishjoker3 invite " in msg.text:
                midd = msg.text.replace("Alishjoker3 invite ","")
                ...
                cl.sendMessage(msg)
            elif msg.text in ["Alishjoker1"]:
                msg.contentType = 13
                msg.contentMetadata = {'mid': Amid}
                ki.sendMessage(msg)
            elif msg.text in ["Alishjoker2"]:
                msg.contentType = 13
                ...
                msg.text = None
                cl.sendMessage(msg)
            elif msg.text in ["æ„›ã®ãƒ—ãƒ¬ã‚¼ãƒ³ãƒˆ","Alishjoker1 gift"]:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': 'a0768339-c2d3-4189-9653-2909e9bb6f58',
                                    'PRDTYPE': 'THEME',
                                    'MSGTPL': '6'}
                msg.text = None
                ki.sendMessage(msg)
            elif msg.text in ["æ„›ã®ãƒ—ãƒ¬ã‚¼ãƒ³ãƒˆ","Alishjoker2 gift"]:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': 'a0768339-c2d3-4189-9653-2909e9bb6f58',
                                    'PRDTYPE': 'THEME',
                                    'MSGTPL': '8'}
                msg.text = None
                kk.sendMessage(msg)
            elif msg.text in ["æ„›ã®ãƒ—ãƒ¬ã‚¼ãƒ³ãƒˆ","Alishjoker3 gift"]:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': 'a0768339-c2d3-4189-9653-2909e9bb6f58',
                                    'PRDTYPE': 'THEME',
                                    'MSGTPL': '10'}
            ...
            elif msg.text in ["Alishjoker cancel","Bot cancel"]:
                if msg.toType == 2:
                ...
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["Alishjoker1 ourl","Alishjoker1 link on"]:
                if msg.toType == 2:
                    X = cl.getGroup(msg.to)
                    X.preventJoinByTicket = False
                    ki.updateGroup(X)
                    if wait["lang"] == "JP":
                        ki.sendText(msg.to,"Done Alishjoker")
                    else:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["Alishjoker2 ourl","Alishjoker2 link on"]:
                if msg.toType == 2:
                    X = kk.getGroup(msg.to)
                    X.preventJoinByTicket = False
                    kk.updateGroup(X)
                    if wait["lang"] == "JP":
                        kk.sendText(msg.to,"Done Alishjoker")
                    else:
            ...
            elif msg.text in ["Alishjoker3 ourl","Alishjoker3 link on"]:
                if msg.toType == 2:
                    X = kc.getGroup(msg.to)
                    X.preventJoinByTicket = False
                    kc.updateGroup(X)
                    if wait["lang"] == "JP":
                        kc.sendText(msg.to,"Done Alishjoker")
                    else:
                ...
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["Alishjoker1 curl","Alishjoker1 link off"]:
                if msg.toType == 2:
            ...
            elif msg.text in ["Alishjoker2 curl","Alishjoker2 link off"]:
                if msg.toType == 2:
                    X = kk.getGroup(msg.to)
                    X.preventJoinByTicket = True
                    kk.updateGroup(X)
                    ...
                    if wait["lang"] == "JP":
                        ...
                        kk.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["Alishjoker3 curl","Alishjoker3 link off"]:
                if msg.toType == 2:
                    X = kc.getGroup(msg.to)
                    X.preventJoinByTicket = True
                    kc.updateGroup(X)
		...
		for ticket_id in n_links:
			if wait["atjointicket"] == True:
                ...
                cl.sendText(msg.to,mid)
            elif "Alishjoker1 mid" == msg.text:
                ki.sendText(msg.to,Amid)
            elif "Alishjoker2 mid" == msg.text:
            ...
            elif msg.text in ["Alishjoker1 rename "]:
                string = msg.text.replace("Alishjoker1 rename ","")
                if len(string.decode('utf-8')) <= 20:
                    profile_B = ki.getProfile()
                    profile_B.displayName = string
                    ki.updateProfile(profile_B)
                    ki.sendText(msg.to,"name " + string + " done")
            elif msg.text in ["Alishjoker2 rename "]:
                string = msg.text.replace("Alishjoker2 rename ","")
                if len(string.decode('utf-8')) <= 20:
                ...
                if albums != []:
                    for album in albums:
                        ...
                        i += 1
                if wait["lang"] == "JP":
                    cl.sendText(msg.to,str(i) + "Album Di Hapus")
                else:
                ...
                if wait["lang"] == "JP":
                    cl.sendText(msg.to,"Semua undangan telah di tolak")
                else:
                ...
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["Alishjoker1 gurl"]:
                if msg.toType == 2:
                    x = cl.getGroup(msg.to)
                    if x.preventJoinByTicket == True:
                        x.preventJoinByTicket = False
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["Alishjoker2 gurl"]:
                if msg.toType == 2:
                    x = cl.getGroup(msg.to)
                    if x.preventJoinByTicket == True:
                        x.preventJoinByTicket = False
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["Alishjoker3 gurl"]:
                if msg.toType == 2:
                    x = cl.getGroup(msg.to)
                    if x.preventJoinByTicket == True:
                        x.preventJoinByTicket = False
...
#-----------------------------------------------
            ...
            elif msg.text in ["Alishjoker1 join"]:
                  X = cl.getGroup(msg.to)
                  X.preventJoinByTicket = False
                  cl.updateGroup(X)
                  invsend = 0
            ...
            elif msg.text in ["Alishjoker2 join"]:
                  X = cl.getGroup(msg.to)
                  X.preventJoinByTicket = False
                  cl.updateGroup(X)
                  invsend = 0
...
#.acceptGroupInvitationByTicket(msg.to,Ticket)
            elif msg.text in ["Alishjoker3 join"]:
                        G = cl.getGroup(msg.to)
                        ginfo = cl.getGroup(msg.to)
                        G.preventJoinByTicket = False
                        cl.updateGroup(G)
...
#-----------------------------------------------
                ...
                if msg.toType == 2:
                    ...
                    try:
                        ...
                        pass
            elif msg.text in ["Alishjoker1 @bye"]:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
                        ki.leaveGroup(msg.to)
                        ...
                        pass
            elif msg.text in ["Alishjoker @bye"]:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
                        kk.leaveGroup(msg.to)
...
#-----------------------------------------------
            ...
            elif msg.text in ["Alish"]:
                ki.sendText(msg.to,"Awas dia ngangenin")
		
            elif msg.text in ["Smule"]:
                ki.sendText(msg.to,"Follow ID Smule Aku Ya line.me/R/ti/p/%40nlr3381q")
...
#-----------------------------------------------
                ...
                ki.sendText(msg.to,"Have a nice dream Alishjoker 􀜁􀅔Har Har􏿿")
            elif msg.text in ["USN"]:
                ki.sendText(msg.to,"Urang Sunda Ngahiji")
                kk.sendText(msg.to,"Silih Asah,Silih Asih, Silih Asuh")
                kc.sendText(msg.to,"Smule ID: joker.alish")
            elif msg.text in ["Welcome"]:
                ki.sendText(msg.to,"salam Be Group Khosh Omadi add Me line.me/R/ti/p/%40nlr3381q")
                kk.sendText(msg.to,"Alishjoker")
#-----------------------------------------------
            elif msg.text in ["PING","Ping","ping"]:
                ki.sendText(msg.to,"Ping Juga ah, hehehe")
#-----------------------------------------------
            elif msg.text in ["Respon","respon"]:
                ki.sendText(msg.to,"Alishjoker1")
                kk.sendText(msg.to,"Alishjoker2")
                kc.sendText(msg.to,"Alishjoker3")
#-----------------------------------------------
